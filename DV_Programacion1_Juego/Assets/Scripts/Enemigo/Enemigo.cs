...
public class Enemigo : MonoBehaviour
{
    ...
    {
        vida -= damage; // Reducir la vida por la cantidad de da�o recibido
    ...
    private IEnumerator FadeAndDestroy()
    {
        ...
        // Asegurarse de que el objeto sea destruido despu�s del fade
        Destroy(gameObject);
    }
    ...
    private void SpawnEnemies()
    {
        if (isBoss)
        {
            ...
            // Instancia dos enemigos a una distancia razonable entre s�
